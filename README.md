...
3. **Baixar o modelo Transformer**:
   - Certifique-se de que o modelo Transformer necessário está disponível no caminho especificado no código. Caso contrário, faça o download do modelo apropriado e ajuste o caminho no arquivo de configuração. O modelo utilizado foi 
